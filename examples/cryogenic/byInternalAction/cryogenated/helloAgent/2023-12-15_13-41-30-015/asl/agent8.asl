...
kqml::bel_no_source_self(NS,Content,Ans)[hide_in_mind_inspector,source(self)] :- (NS::Content[|LA] & (kqml::clear_source_self(LA,NLA) & ((Content =.. [F,T,_137]) & (NS::Ans =.. [NS,F,T,NLA])))).
...
/* Plans */
@p__8[source(self),url("file:examples/cryogenic/byInternalAction/hello-agent/asl/agent8.asl")] +!start : day <- .print("Hello world!!!").
